...
class Config:
    ...
    def _load_initial_config(self):
        ...
        openrouter_api_key = os.getenv("OPENROUTER_API_KEY", "")  # 新增OpenRouter支持
        ...
        if amap_api_key:
            amap_settings = AMapSettings(
                ...
                web_api_key=os.getenv("AMAP_WEB_API_KEY", amap_config.get("web_api_key"))
            )
